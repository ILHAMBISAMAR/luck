             ...
             case 'superancient':
                if (global.db.data.users[m.sender].superancient >= count * 1) {
                    try {
                        ...
                        global.db.data.users[who].superancient += count * 1
                        conn.reply(m.chat, `Berhasil mentransfer ${count} superancient`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].superancient += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
                ...
                } else conn.reply(m.chat, `Superancient kamu tidak cukup`.trim(), m)
                break
            case 'sapphire':
            ...
            case 'superior':
                if (global.db.data.users[m.sender].superior >= count * 1) {
                    try {
                        ...
                        global.db.data.users[who].superior += count * 1
                        conn.reply(m.chat, `Berhasil mentransfer ${count} superior`.trim(), m)
                    } catch (e) {
                        global.db.data.users[m.sender].superior += count * 1
                        m.reply('Gagal Menstransfer')
                        console.log(e)
