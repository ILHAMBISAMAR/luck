        ...
        if (/shop|toko|buy/i.test(command)) {
               ...
               if (global.db.data.users[m.sender].naga == 1) return conn.reply(m.chat, 'Kamu sudah memiliki pet ini', m)
                ...
                case 'foodpet':
                    ...
                    case `sapphire`:
                            ...
                            global.db.data.users[m.sender].zamrud -= Bsapphire * count
                            global.db.data.users[m.sender].sapphire += count * 1
                            conn.reply(m.chat, `Sukses Membeli ${count} sapphire ⚱ Dengan Harga ${Bsapphire * count} zamrud`, m)
                            } else conn.reply(m.chat, `zamrud Anda Tidak Cukup Untuk Membeli ${count} Sapphire Dengan Harga ${Bsapphire * count} zamrud `,)
                        break
                    case 'bibitmangga':
                    ...
                    case 'legendary':
                        ...
                        break
                    case 'superior':
                            if (global.db.data.users[m.sender].money >= Bsuperior * count) {
                                global.db.data.users[m.sender].superior += count * 1
                                global.db.data.users[m.sender].money -= Bsuperior * count
                                conn.reply(m.chat, `✔️ Sukses Membeli ${count} Superior Crate 👑 Dengan Harga ${Bsuperior * count} Money 💹`, m)
                    ...
                    case 'ancient':
                        ...
                        break
                    case 'superancient':
                            if (global.db.data.users[m.sender].sapphire >= Bsuperancient * count) {
                                global.db.data.users[m.sender].superancient += count * 1
                                global.db.data.users[m.sender].sapphire -= Bsuperancient * count
                                conn.reply(m.chat, `✔️ Sukses Membeli ${count} superancient Crate 🔐 Dengan Harga ${Bsuperancient * count} sapphire ⚱`, m)
                            } else conn.reply(m.chat, `Sapphire Anda Tidak Cukup Untuk Membeli ${count} superancient Crate 🔐 Dengan Harga ${Bsuperancient * count} Sapphire  ⚱\n\n📍 Buka Crate Dengan Ketik: *${usedPrefix}open superancient*`, m)
                ...
                switch (_type) {
                    ...
                    case 'sapphire':
                        if (global.db.data.users[m.sender].sapphire >= count * 1) {
                            global.db.data.users[m.sender].zamrud += Ssapphire * count
                            global.db.data.users[m.sender].sapphire -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${count} Sapphire ⚱ Dengan Harga ${Ssapphire * count} zamrud 🔮`.trim(), m)
                    ...
                    case 'superior':
                     ...
                     case 'ancient':
                        ...
                        break
                     case 'superancient':
                        if (global.db.data.users[m.sender].superancient >= count * 1) {
                            global.db.data.users[m.sender].sapphire += Ssuperancient * count
                            global.db.data.users[m.sender].superancient -= count * 1
                            conn.reply(m.chat, `✔️ Sukses Menjual ${count} superancient Crate 🔐 Dengan Harga ${Sancient * count} saphire ⚱`.trim(), m)
                        } else conn.reply(m.chat, `🔐 superancient Crate Kamu Tidak Cukup `.trim(), m)
                        break
                     case 'pet':
            ...
            switch (type) {
                ...
                case 'ancient':
                    ...
                    break
                case 'superancient':
                        if (global.db.data.users[m.sender].sapphire >= Bsuperancientt * count) {
                            global.db.data.users[m.sender].superancient += count * 1
                            global.db.data.users[m.sender].sapphire -= Bsuperancient * count
                            conn.reply(m.chat, `Sukses Membeli ${count} superancient Crate Dengan Harga ${Bsuperancient * count} sapphire`, m)
                        } else conn.reply(m.chat, `sapphire Anda Tidak Cukup Untuk Membeli ${count} superancient Crate Dengan Harga ${Bsuperancient * count} sapphire \n\nBuka Crate Dengan Ketik: *${usedPrefix}open superancient*`, m)
